...
<div style="padding: 20px 4px 0;">
    ...
    <div style="display:flex; gap:12px; margin-bottom:18px;">
        <div style="flex:1; background:#fefae0; border-radius:18px; padding:16px; text-align:center;">
            ...
            <div style="font-size:26px; font-weight:700; color:#3f4a35;">2</div>
        ...
        <div style="flex:1; background:#fefae0; border-radius:18px; padding:16px; text-align:center;">
            ...
            <div style="font-size:26px; font-weight:700; color:#3f4a35;">17</div>
    ...
    <div style="background:#fff; border-radius:18px; overflow:hidden; box-shadow:0 4px 12px rgba(95,111,82,.1);">
        <div style="display:flex; align-items:center; justify-content:space-between; padding:14px 18px; background:#eef1e0;">
            <span style="font-weight:700; color:#3f4a35; font-size:14px;">Log Aktivitas</span>
            <a href="#" style="font-size:12px; font-weight:600; color:#5f6f52; background:#dfe5cf; padding:6px 12px; border-radius:20px; text-decoration:none;">Lihat Semua</a>
        </div>
        ...
        @foreach ($logs as $log)
            <div style="display:flex; align-items:center; justify-content:space-between; padding:12px 18px; border-top:1px solid #f0efe6;">
                <div style="display:flex; align-items:center; gap:10px;">
                    <span style="width:30px; height:30px; border-radius:50%; background:#eef1e0; display:grid; place-items:center; color:#5f6f52;">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="8" r="4"/><path d="M6 21v-2a4 4 0 0 1 4-4h4a4 4 0 0 1 4 4v2"/></svg>
                    </span>
                    <div>
                        <p style="margin:0; font-size:13.5px; font-weight:600; color:#b5651d;">{{ $log['nama'] }} - {{ $log['kerja'] }}</p>
